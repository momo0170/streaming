...
export default function Header() {
  return (
    <header className="flex justify-between p-2 border-b h-13">
      ...
      <div className="flex">
        <button className="bg-gray-200 mx-2 px-4 py-1 rounded text-sm font-semibold hover:bg-gray-300">
          로그인
        </button>
        <button className="bg-violet-600 text-white mx-2 px-4 py-1 rounded text-sm font-semibold hover:bg-violet-700">
          회원가입
        </button>
      </div>
    </header>
