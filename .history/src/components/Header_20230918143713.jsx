  ...
  return (
    <header className="flex justify-between m-2">
      ...
      <form className="flex">
        <input
          type="text"
          className="rounded-l-md outline outline-1 p-1 px-2 box-border focus:outline-violet-600 focus:outline-1.5 hover:outline-1.5 hover:outline-black align-middle"
        />
