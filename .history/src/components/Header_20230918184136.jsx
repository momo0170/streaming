  ...
  return (
    <header className="flex justify-between p-2 border-b">
      ...
      <div className="relative">
        <button className="bg-gray-200 mx-2 px-4 py-1 rounded text-sm font-semibold hover:bg-gray-300 top-1/2">
          로그인
        </button>
        <button className="bg-violet-600 text-white mx-2 px-4 py-1 rounded text-sm font-semibold hover:bg-violet-700 top-1/2">
          회원가입
        </button>
      </div>
    </header>
